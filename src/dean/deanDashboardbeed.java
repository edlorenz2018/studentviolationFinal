 ...
 * @author NiQby
 */
public class deanDashboardbeed extends javax.swing.JFrame {

    /**
     * Creates new form deanDashboardbeed
     */
    public deanDashboardbeed() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        course.setFont(new java.awt.Font("Arial Black", 0, 24)); // NOI18N
        course.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        course.setText("test");
        jPanel2.add(course);
        course.setBounds(0, 180, 180, 30);
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8-find-user-male-100.png"))); // NOI18N
        jPanel5.add(jLabel8);
        jLabel8.setBounds(40, 10, 110, 100);

        jLabel6.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("VIEW STUDENTS");
        jPanel5.add(jLabel6);
        jLabel6.setBounds(10, 110, 180, 21);

        jPanel3.add(jPanel5);
        jPanel5.setBounds(200, 160, 190, 130);
    ...
    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
             Session sess = Session.getInstance();   
            viewBeeDashboard vbd = new viewBeeDashboard();
                  vbd.course1.setText(""+sess.getProgram());
                  vbd.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deanDashboardbeed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deanDashboardbeed().setVisible(true);
            }
        });
    }
